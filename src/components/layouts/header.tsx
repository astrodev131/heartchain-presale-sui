...
export const Header = (props) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full min-h-60 md:min-h-80 lg:h-90 px-[8vw] flex flex-row-reverse mm:flex-row gap-50 items-center justify-between bg-[#606068] z-10">
      <div
